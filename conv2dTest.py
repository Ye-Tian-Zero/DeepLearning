...
W = theano.shared(np.array(rng.uniform(low = -1 / w_bound, high = 1 / w_bound, size=w_shp), dtype = input.dtype))
b = theano.shared(np.array(rng.uniform(low = -0.5, high = -0.5, size = (3,)), dtype  = input.dtype), name = 'b')
